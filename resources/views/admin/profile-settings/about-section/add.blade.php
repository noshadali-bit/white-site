    ...
    <div class="main-sec">
        <div class="main-wrapper">
            ...
            <div class="user-wrapper">
                <form id="add-record-form" action="{{ route('admin.profile.create_about_section') }}"
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                <label>Heading*:</label>
                                <input type="text" name="headings" id="headings" value="{{ old('headings') }}" required
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea rows="5" class="form-control" placeholder="Enter Short Description" name="long_desc">{{ old('long_desc') }}</textarea>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="text-center">
                            <button id="add-record" type="submit" class="primary-btn primary-bg">Add New</button>
                        </div>
                    </div>
                </form>
