   ...
   <section class="dashboard-sec">
        <div class="wrapper-container">
            <div class="dashboard-form-sec">
                ...
                <form action="{{route('dashboard.updatePets')}}" method="POST" enctype="multipart/form-data" class="main-form pet-form" id="pet-form">
                      @csrf
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                <label>Breed</label>
                                <input type="text" name="breed" value="{{$pets->breed}}" required class="form-control">
                        ...
                        <div class="col-lg-12 col-md-12 col-12 other-pet-div" style="display: none;">
                            <div class="form-group">
                                ...
                                <input type="text" name="other_pet_name" value="{{$pets->other_pet_name}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                <label>Pet Name</label>
                                <input type="text"  name="pet_name" value="{{$pets->pet_name}}" required class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                <label>Age</label>
                                <input type="text" name="pet_age" value="{{$pets->pet_age}}" required class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                <label>Color</label>
                                <input type="text" required value="{{$pets->color}}" name="color" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="vet_clinic" value="{{$pets->vet_clinic}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$pets->amt_feeding}}" name="amt_feeding" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    <input type="radio" name="medication" id="medication-yes"  {{$pets->medication == 'yes' ? 'checked':''}} value="yes">
                                    <label for="medication-yes" class="medication-btn"><span></span>Yes</label>
                                </div>
                                <div class="checkbox">
                                    <input type="radio" name="medication" id="medication-no" value="no" {{$pets->medication == 'no' ? 'checked':''}}>
                        ...
                        <div class="col-lg-12 col-md-12 col-12 special-instruction-div" style="display: none;">
                            <div class="form-group">
                                ...
                                <input type="text" name="sp_instr" value="{{$pets->sp_instr}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-12 medication-div" style="display: none;">
                            <div class="form-group">
                                <label>Type Medication</label>
                                <input type="text" name="type_medication" value="{{$pets->type_medication}}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group notes">
                                <label>Notes</label>
                                <textarea class="form-control" name="notes" rows="4" maxlength="512">{{$pets->notes}}</textarea>
