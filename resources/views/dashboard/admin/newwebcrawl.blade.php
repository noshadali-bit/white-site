                        ...
                        <!-- <div class="row align-items-end">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control" id="keywords" name="keywords"  required placeholder="Enter Keywords (Separate by comma)"></textarea>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <div class="checkbox">
                                                <input type="radio" id="filter1" class="domain_name" name="domain_name" value="1" checked>
  ...
  $('.run').click(function() {
      ...
      if(keywords != '')
      {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data:{keywords:keywords,domain_name:domain_name},
                beforeSend: function() {
                   Loader.show();
                },
