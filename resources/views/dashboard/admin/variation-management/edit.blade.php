                        ...
                        <div class="col-lg-6 col-md-6 col-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-6">
                                <div class="form-group">
                                  ...
                                  <select  class="form-control coloradd" name="color" required>

                                  @if($variation->color_id != 0)
                            
                                <option value="{{$variation->color_id}}" selected="selected">{{$variation->variationBelongsToColor->name}}</option>
                            ...
                            <div class="col-lg-6 col-md-6 col-6">
                                <div class="form-group">
                                    ...
                                    <select  class="form-control" name="size_id" required>
                                      @foreach($size as $s)
                                      <option {{$variation->size_id == $s->id ? 'selected':''}} value="{{$s->id}}">{{$s->name}}</option>
                                      @endforeach
</select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-6">
                                <div class="form-group">
                                    <label>Stock*:</label>
                                    <input type="text"  class="form-control" name="stock"  value="{{$variation->stock}}"  required   placeholder="Stock" >
