...
<div class="main-sec">
            <div class="main-wrapper">
                ...
                <div class="user-wrapper">
                    <form id="add-record-form" action="{{route('admin.savematches')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                    ...
                    @csrf
                       ...
                       <input type="hidden" name="id" value="{{$matches->id}}">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="team1" required class="form-control">
                                        ...
                                        <option value="{{$t->id}}" {{$t->id == $matches->team1_id ? 'selected' : ''}}>{{$t->name}}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('team1'))
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="team2" required class="form-control">
                                        ...
                                        <option value="{{$t->id}}" {{$t->id == $matches->team2_id ? 'selected' : ''}}>{{$t->name}}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('team2'))
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <label>Dated*:</label>
                                    <input type="datetime-local" required name="dated" value="{{$matches->dated}}" class="form-control">
                                    @if ($errors->has('dated'))
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="broadcast" value="{{$matches->broadcast}}" placeholder="Broadcaster Name" class="form-control">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="live_stream" value="{{$matches->live_stream}}" placeholder="Live Stream Link" class="form-control">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <option value="1" {{$matches->match_type == 1 ? 'selected' : ''}}>Hockey</option>
                                    <option value="2" {{$matches->match_type == 2 ? 'selected' : ''}}>Broadcast</option>
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="img-upload-wrapper  mc-b-3">
                              ...
                              <figure><img src="{{asset($matches->img_path)}}" class="thumbnail-img" alt="user-img"></figure>
                        ...
                        <div class="text-center">
                            ...
                            <button id="add-record" type="submit" class="primary-btn primary-bg">Save</button>
                        </div>
                    </div>
                    </form>
