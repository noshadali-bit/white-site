...
<div class="main-sec">
            <div class="main-wrapper">
                ...
                <div class="user-wrapper">
                    <form id="add-record-form" action="{{route('admin.savenews_events')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <label>News Title*:</label>
                                    <input type="text" name="title" id="name" value="{{$news->title}}" required class="form-control" placeholder="Enter Title">
...
@endif
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <label>Date*:</label>
                                    <input type="date" name="date"  value="{{$news->date}}" required class="form-control" >
                                    @if ($errors->has('date'))
...
@endif
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="img-upload-wrapper  mc-b-3">
                              ...
                              <figure><img src="{{asset($news->news_img)}}" class="thumbnail-img" alt="user-img"></figure>
